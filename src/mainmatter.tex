...
Answer Set Programming (ASP) is one of the most successful programming paradigms for declarative problem solving in particular 
...
academic and industry work~\cite{EGL16}. However, even though it has been around for over 20 years~\cite{Nie99, MT98}, there 
is still a significant lack of good workflow tools. Such tools can help make the development process more streamlined and allow 
approaches that are very effective in more conventional programming languages such as test driven development (TDD,~\cite{Fra+03}).
This also helps increase the reach and acceptance of ASP.
Research into these topics exists and has yielded results, however many topics remain unexplored.

In this Thesis I want to focus on the topic of code coverage for ASP. 
